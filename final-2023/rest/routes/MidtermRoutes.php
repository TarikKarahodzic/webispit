...
Flight::route('GET /midterm/investor_email/@email', function($email){
    ...
    */
    $service = new MidtermService();
    $service->investor_email($email);
});

Flight::route("GET /midterm/investor/@share_class_id", function($id){
    /** TODO
    * This endpoint is used to list all investors from given share_class
    ...
    */
    $service = new MidtermService();
    $investors = $service->investors($id);
